...
**Ожидаемый результат:** Сообщение "Операция одобрена Банком." В БД создается запись со статусом APPROVED.
...
**Ожидаемый результат:** Сообщение "Банк отказал в проведении операции." В БД создается запись со статусом DECLINED.
...
**Ожидаемый результат:** Сообщение "Банк отказал в проведении операции.", форма не отправляется.
...
**Ожидаемый результат:** Под полем "Месяц" сообщение "Неверный формат", форма не отправляется.
