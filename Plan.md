...
---
**Сценарий 10:** Отправка формы с пустым полем "Владелец"
...
---
**Сценарий 11:** Отправка формы с CVC/CVV из 2 цифр
...
---
**Сценарий 12:** Отправка формы с CVC/CVV из 4 цифр
...
---
### 3. Сценарии проверки данных и интеграций
**Сценарий 14:** Проверка сохранения данных в БД без информации о карте

### Шаги:
- Выполнить успешную оплату по APPROVED карте

- Проверить записи в таблице в БД

**Ожидаемый результат:** В БД создана запись с полями: id, amount, created, status, transaction_id. Данные карты отсутствуют.

---
**Сценарий 15:** Проверка логов банковского сервиса

### Шаги:
- Выполнить успешную оплату по APPROVED карте

- Открыть логи банковского сервиса http://185.119.57.197:9998

- Найти свои запросы по IP

**Ожидаемый результат:** В логах присутствует запрос к Payment Gate с данными карты и ответ APPROVED.
